...
const About = () =>{
  return(
    <div className='about'>
      ...
      <br/><br/>
      By combining self-study with 500+ hours of pair programming experience, I have been able to learn several languages, frameworks and programming principles in just a few months.<br/><br/>
